create
    definer = openmrs@`%` procedure CreatePatientsWithDefaultVisitDistribution(IN numPatients int, IN numVisits int)
BEGIN
...
-- Ensure the generated hour is within the desired range (02:00 to 10:00)
            SET @randomHour = CASE
                                  WHEN @randomHour < 11 THEN 11
                                  WHEN @randomHour > 19 THEN 19
                                  ELSE @randomHour
                END;
